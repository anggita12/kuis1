		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?php echo site_url('web/anggota');?>"> Anggota</a></li>
                    </ul>
                    ...
                    <div class="col-md-8 ">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td><?php
									if ($row->image == ""){
										echo'<img src="';echo base_url('assets/img/anggota/no-foto.png');echo'" height="90" width="80px">';
									}
									else{
										echo'<img src="';echo base_url('assets/img/anggota/'.$row->image);echo'" height="90" width="80px">';
									}
									?>
								</td>
